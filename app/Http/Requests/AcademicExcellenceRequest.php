...
class AcademicExcellenceRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'grades.*.lt' => 'Sorry, you have grades lower than 2.75 in First Year - !st Semester.',
            'grades1.*.lt' => 'Sorry, you have grades lower than 2.75 in First Year - 2nd Semester.',
            'grades3.*.lt' => 'Sorry, you have grades lower than 2.75 in Second Year - !st Semester.',
            'grades4.*.lt' => 'Sorry, you have grades lower than 2.75 in Second Year - 2nd Semester.',
            'grades5.*.lt' => 'Sorry, you have grades lower than 2.75 in Third Year - !st Semester.',
            'grades6.*.lt' => 'Sorry, you have grades lower than 2.75 in Third Year - 2nd Semester.',
            'grades7.*.lt' => 'Sorry, you have grades lower than 2.75 in Fourth Year - !st Semester.',
