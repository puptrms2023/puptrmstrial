        ...
        <div class="col-xl-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Edit Subject
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('admin/maintenance/subjects/' . $subject->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="course_code" class="form-control" value="{{ $subject->s_code }}"
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <input type="text" name="course_description" class="form-control"
                                    value="{{ $subject->s_name }}"placeholder="Course description">
