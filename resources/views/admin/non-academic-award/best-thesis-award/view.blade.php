...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800"> Best Thesis Award
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <div class="m-0 font-weight-bold text-primary">
                        Student Information
                        <a href="{{ url('admin/non-academic-award/best-thesis-award') }}"
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th width="25%">Thesis/Capstone Title</th>
                                <td>{{ $form->thesis_title }}</td>
                            </tr>
                            <tr>
