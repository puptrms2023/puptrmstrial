...
@section('content')
    <div class="modal" tabindex="-1" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/non-academic-award/leadership-award/delete-form') }}" method="POST">
                    @csrf
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800">Leadership Award</div>
    </div>
                        ...
                        <tbody>
                            @foreach ($form as $award)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/non-academic-award/leadership-award/' . $award->id) }}"
