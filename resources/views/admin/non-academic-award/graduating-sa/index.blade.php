...
@section('content')
    <div class="modal" tabindex="-1" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/non-academic-award/graduating-sa/delete-form') }}" method="POST">
                    @csrf
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800">Graduating Student Assistants</div>
    </div>
                        ...
                        <tbody>
                            @foreach ($form as $award)
                                <tr>
                                    ...
                                    <td>{{ $award->designated_office }}</td>
                                    <td>
                                        <img src="{{ asset('uploads/' . $award->image) }}" class="img-thumbnail img-circle"
                                            width="50" alt="Image">
                                    </td>
                                    <td>
                                        <a href="{{ url('admin/non-academic-award/graduating-sa/' . $award->id) }}"
