...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800"> Outstanding Organization Award Applicant
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <div class="m-0 font-weight-bold text-primary">
                        Student Information
                        <a href="{{ url('admin/non-academic-award/outstanding-organization-award') }}"
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th width="25%">Sports</th>
                                <td><span class="badge badge-primary">{{ $form->sports }}</span></td>
                            </tr>
                            <tr>
