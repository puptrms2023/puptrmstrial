        ...
        <div class="col-xl-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Create Event
                        <a href="{{ url('admin/calendar-events') }}" class="btn btn-primary btn-sm float-right">Back</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('admin/calendar-events') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="event_name" class="form-control"
                                    value="{{ old('event_name') }}"placeholder="Enter name">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <span class="text-danger">*</span>
                                <textarea id="description" name="description" placeholder="Enter desctiption" class="form-control">{{ old('description') }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="eventRadio" id="inlineRadio1"
                                        value="allday_radio" {{ old('eventRadio') == 'allday_radio' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="eventRadio" id="inlineRadio2"
                                        value="longevent_radio"
                                        {{ old('eventRadio') == 'longevent_radio' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="eventRadio" id="inlineRadio3"
                                        value="allday_duration"
                                        {{ old('eventRadio') == 'allday_duration' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="eventRadio" id="inlineRadio4"
                                        value="time_duration" {{ old('eventRadio') == 'time_duration' ? 'checked' : '' }}>
                            ...
                            {{-- all day --}}
                            <div id="all" class="col-md-12 mb-3 hidden">
                            ...
                            <div id="long" class="col-md-12 mb-3 hidden">
                                ...
                                <div class="input-group date" id="startLongDay" data-target-input="nearest">
                                    <input type="text" id="longstart-value" name="start_long_event"
                                        class="form-control datetimepicker-input" data-target="#startLongDay" />
                                    <div class="input-group-append" data-target="#startLongDay"
                                ...
                                <div class="input-group date" id="endLongDay" data-target-input="nearest">
                                    <input type="text" id="longend-value"
                                        name="end_long_event"class="form-control datetimepicker-input"
                                        data-target="#endLongDay" />
                                    <div class="input-group-append" data-target="#endLongDay"
                                        data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                            ...
                            <div id="alld" class="col-md-12 mb-3 hidden">
                                <label class="small">Start</label>
                                <div class="input-group date" id="startAllDay" data-target-input="nearest">
                                    <input type="text" id="allid-value" name="all_day_event_duration"
                                        class="form-control datetimepicker-input" data-target="#startAllDay" />
                                    <div class="input-group-append" data-target="#startAllDay"
                                        data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
