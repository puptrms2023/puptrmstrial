...
@section('content')
                ...
                <div class="card-header">
                    <div class="m-0 font-weight-bold text-primary">1st Semester Grades
                        <button type="button" id="editGrades1"
                            data-url="{{ route('achievers.edit-grades-content', $status->id) }}" data-id="1"
                            class="btn btn-sm float-right"><i class="fa-solid fa-pen-to-square"></i></button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="first" class="table table-bordered table-sm" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Course Code</th>
                ...
                <div class="card-header">
                    <div class="m-0 font-weight-bold text-primary">2nd Semester Grades
                        <button type="button" id="editGrades2"
                            data-url="{{ route('achievers.edit-grades-content', $status->id) }}" data-id="2"
                            class="btn btn-sm float-right"><i class="fa-solid fa-pen-to-square"></i></button>
                    </div>
                </div>
                <div class="card-body">
    ...
    @can('achievers edit')
        <div class="row">
            <div class="col-md-6">
                <form
                    action="{{ url('admin/achievers-award/' . $status->courses->course_code . '/update-status/' . $status->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
    ...
    @include('admin.achievers-award.grades')
    @include('admin.achievers-award.image')
@endsection
