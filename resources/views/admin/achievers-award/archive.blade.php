...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800">Archives Achievers Award - {{ $course->course_code }}</div>
    </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Students
                        <a href="{{ url('admin/achievers-award/' . $course->course_code) }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        @if (count($form) > 0)
                            <div class="mb-3">
                                <a href="{{ route('achievers.restore_all', $course->course_code) }}"
                            ...
                            <tbody>
                                @foreach ($form as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('achievers.restore', $data->id) }}"
