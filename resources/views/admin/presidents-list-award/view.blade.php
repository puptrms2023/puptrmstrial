    ...
    <div class="modal" tabindex="-1" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/presidents-list-award/' . $courses->course_code . '/delete-form') }}"
                    method="POST">
                    @csrf
        ...
        <div class="col-md-12 mb-2">
            <div class="form-row">
                ...
                <div class="col-auto col-xs-12">
                    <button type="button" class="btn btn-success view-accepted-pl">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Students | <a
                            href="{{ url('admin/archive/presidents-list-award/' . $courses->course_code) }}"
                            class="text-info">
                            View Archive
