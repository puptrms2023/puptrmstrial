...
@section('content')
                ...
                <div class="card-header">
                    <div class="m-0 font-weight-bold text-primary">1st Semester Grades
                        <button type="button" id="editGrades1"
                            data-url="{{ route('president.edit-grades-content', $status->id) }}" data-id="1"
                ...
                <div class="card-header">
                    <div class="m-0 font-weight-bold text-primary">2nd Semester Grades
                        <button type="button" id="editGrades2"
                            data-url="{{ route('president.edit-grades-content', $status->id) }}" data-id="2"
                            class="btn btn-sm float-right"><i class="fa-solid fa-pen-to-square"></i></button>
                    </div>
                </div>
                <div class="card-body">
    ...
    @endcan
    @include('admin.presidents-list-award.grades')
    @include('admin.presidents-list-award.image')
@endsection
