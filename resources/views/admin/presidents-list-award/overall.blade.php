            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Students | <a
                            href="{{ url('admin/archive-all/presidents-list-award/') }}" class="text-info">
                            View Archive
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-data-pl-overall" width="100%"
                            cellspacing="0">
...
@section('scripts')
    ...
    <script>
        var table = $(".table-data-pl-overall").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('admin/presidents-list-award/overall') }}",
                data: function(d) {
                    (d.status = $("#status").val());
                },
            },
            ...
            $(document).on('click', '#bulk_delete', function() {
                ...
                $(document).on('click', '.delbtn', function() {
                    ...
                    if (bulkID.length > 0) {
                        ...
                        $.ajax({
                            url: "{{ url('admin/presidents-list-award/bulk-delete-form') }}",
                            type: "DELETE",
                            headers: {
                            ...
                            success: function(data) {
                                if (data['success']) {
                                    $('.table-data-pl-overall').DataTable().ajax
                                        .reload(null, true);
