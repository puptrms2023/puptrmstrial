...
<head>
    <title>Rejected Dean's List Applicants - {{ $courses->course_code }}</title>
    <style type="text/css">
        body {
...
<body>
    ...
    <table class="table3">
        <tr>
            <th colspan="2" style="text-align: left; font-size:22px;font-weight:bold;">List of Rejected Dean's Lister
                Applicants - {{ $courses->course }}</th>
        </tr>
        <tr>
