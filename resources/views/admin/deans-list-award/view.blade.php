...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800">{{ $courses->course }} - Dean's List</div>
    </div>
        ...
        <div class="col-md-12 mb-2">
            <div class="form-row">
                ...
                <div class="col-auto col-xs-12">
                    <button type="button" class="btn btn-success view-accepted" formtarget="_blank">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Students | <a
                            href="{{ url('admin/archive/deans-list-award/' . $courses->course_code) }}" class="text-info">
                            View Archive
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-data-dl" width="100%" cellspacing="0">
                        ...
                        <a href="{{ url('admin/deans-list-award/' . $courses->course_code . '/view-all-students-pdf') }}"
...
@section('scripts')
    ...
    <script>
        var table = $(".table-data-dl").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('admin/deans-list-award/' . $courses->course_code) }}",
                data: function(d) {
                    (d.status = $("#status").val()),
                    (d.year = $("#year").val());
                },
            ...
            $(document).on('click', '#bulk_delete', function() {
                ...
                $(document).on('click', '.delbtn', function() {
                    ...
                    if (bulkID.length > 0) {
                        ...
                        $.ajax({
                            url: "{{ url('admin/deans-list-award/' . $courses->course_code . '/bulk-delete-form') }}",
                            type: "DELETE",
                            headers: {
