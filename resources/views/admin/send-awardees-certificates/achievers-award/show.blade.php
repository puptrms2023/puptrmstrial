    ...
    <style type="text/css">
        * {
        ...
        body {
            ...
            height: 8.27in;
            width: 11.69in;
            background-image: url('admin/img/AA.jpg');
...
<body>
    ...
    <div class="description">for the remarkable academic performance as a student of this institution for obtaning<br>
        a <span class="highlight">General Weighted Average</span> of {{ $gwa }} qualified for the <span
            class="highlight">Achiever's Award</span> for the S.Y.
        {{ $sy }}.
    </div>
    <div class="date"><span class="highlight">Given this {{ str_replace(Date::now()->format('jS'), Date::now()->format('jS') . ' day', Date::now()->format('jS \of F Y')) }}</span> via Google Mail</div>
    <table class="table2">
        <tr>
            <td width="21%">
