...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="h3 mb-0 text-gray-800">{{ $courses->course }} - Academic Excellence</div>
    </div>
        ...
        <div class="col-md-12 mb-2">
            <div class="form-row">
                ...
                <div class="col-auto col-xs-12">
                    <button type="button" class="btn btn-success view-accepted-ae" formtarget="_blank">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="m-0 font-weight-bold text-primary">Students | <a
                            href="{{ url('admin/archive/academic-excellence-award/' . $courses->course_code) }}"
                            class="text-info">View Archive
