...
<head>
    <title>Academic Excellence Awardees - {{ $courses->course_code }}</title>
    <style type="text/css">
        body {
...
<body>
    ...
    <table class="table3">
        <tr>
            <th colspan="2" style="text-align: left; font-size:22px;font-weight:bold;">List of Academic Excellence
                Awardees -
                {{ $courses->course }}</th>
