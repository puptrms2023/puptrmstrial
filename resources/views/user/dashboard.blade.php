        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item border-0"><i class="fas fa-solid fa-star text-success"></i> &ensp;<b>GWA
                    ...
                    <li class="list-group-item border-0"><i class="fas fa-solid fa-star text-success"></i>
                        &ensp;Officially enrolled for 1st and 2nd semester
                        of the recent academic year.</li>
                    <li class="list-group-item border-0"><i class="fas fa-solid fa-star text-success"></i> &ensp;Regular
