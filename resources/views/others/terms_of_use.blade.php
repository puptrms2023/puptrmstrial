            ...
            <div class="col-lg-12">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-header bg-white border-0">
                        <h5 class="card-title font-weight-bold text-center">TERMS OF USE</h5>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                                ...
                                <p>These terms of use are entered into by and between You and {{ getSystemName() }} ("we" or
                                ...
                                <p>The {{ getSystemName() }} name and all related names, logos, slogans, mottos, and designs
                                ...
                                <ul>
                                    ...
                                    <li>Attack the Website via a denial-of-service attack or a distributed denial-of-service
                                        attack.</li>
                                    <li>Use the Website in any manner that violates any applicable {{ getSystemName() }}
                                ...
                                <p>YOU WAIVE AND HOLD HARMLESS {{ strtoupper(getSystemName()) }} FROM ANY CLAIMS RESULTING
                                    FROM
                                    ANY ACTION TAKEN BY {{ strtoupper(getSystemName()) }} DURING OR AS A RESULT OF ITS
                                    INVESTIGATIONS AND FROM ANY ACTIONS TAKEN AS A CONSEQUENCE OF INVESTIGATIONS BY
                                    {{ strtoupper(getSystemName()) }} OR LAW ENFORCEMENT AUTHORITIES.</p>
                                ...
                                <p>YOUR USE OF THE WEBSITE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE
                                    ...
                                    {{ strtoupper(getSystemName()) }}
                                    NOR ANY PERSON ASSOCIATED WITH {{ strtoupper(getSystemName()) }} MAKES ANY WARRANTY OR
                                    ...
                                    {{ strtoupper(getSystemName()) }} NOR ANYONE ASSOCIATED WITH
                                    {{ strtoupper(getSystemName()) }}
                                ...
                                <p>{{ strtoupper(getSystemName()) }} HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER
                                    EXPRESS
                                ...
                                <p>IN NO EVENT WILL {{ strtoupper(getSystemName()) }}, ITS AFFILIATES OR THEIR LICENSORS,
                                    SERVICE
                                ...
                                <p>You agree to defend, indemnify and hold harmless {{ getSystemName() }}, its affiliates,
                                ...
                                <p>At {{ getSystemName() }}’s sole discretion, it may require You to submit any disputes
                                ...
                                <p>No waiver of by {{ getSystemName() }} of any term or condition set forth in these Terms
                                    of
                                    Use shall be deemed a further or continuing waiver of such term or condition or a waiver
                                    of any other term or condition, and any failure of {{ getSystemName() }} to assert a
                                ...
                                <p>These Terms of Use and our <a target="_blank"
                                    ...
                                    entire agreement between you and {{ getSystemName() }} with respect to the Website and
                                ...
                                <p>This website is operated by {{ getSystemName() }}.</p>
